...
class Millicache_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Millicache_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Millicache_Loader will then create the relationship
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/millicache-admin.js', array( 'jquery' ), $this->version, false );
