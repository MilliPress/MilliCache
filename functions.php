...
if ( ! function_exists( 'millicache_clear_cache' ) ) {
	/**
...
if ( ! function_exists( 'millicache_clear_cache_by_urls' ) ) {
	/**
...
if ( ! function_exists( 'millicache_clear_cache_by_post_ids' ) ) {
	/**
...
if ( ! function_exists( 'millicache_clear_cache_by_flags' ) ) {
	/**
...
if ( ! function_exists( 'millicache_clear_cache_by_site_ids' ) ) {
	/**
...
if ( ! function_exists( 'millicache_clear_cache_by_network_id' ) ) {
	/**
...
if ( ! function_exists( 'millicache_reset_cache' ) ) {
	/**
...
if ( ! function_exists( 'millicache_add_flag' ) ) {
	/**
...
if ( ! function_exists( 'millicache_remove_flag' ) ) {
	/**
...
if ( ! function_exists( 'millicache_get_flag_prefix' ) ) {
	/**
...
if ( ! function_exists( 'millicache_prefix_flags' ) ) {
	/**
...
if ( ! function_exists( 'millicache_set_ttl' ) ) {
	/**
...
if ( ! function_exists( 'millicache_set_grace' ) ) {
	/**
