...
use MilliCache\Predis\Command\RawCommand;
use MilliCache\Predis\Command\Redis\Container\ContainerFactory;
use MilliCache\Predis\Command\Redis\Container\ContainerInterface;
use MilliCache\Predis\Command\ScriptCommand;
use MilliCache\Predis\Configuration\Options;
use MilliCache\Predis\Configuration\OptionsInterface;
use MilliCache\Predis\Connection\ConnectionInterface;
use MilliCache\Predis\Connection\Parameters;
use MilliCache\Predis\Connection\ParametersInterface;
use MilliCache\Predis\Connection\RelayConnection;
use MilliCache\Predis\Monitor\Consumer as MonitorConsumer;
use MilliCache\Predis\Pipeline\Atomic;
use MilliCache\Predis\Pipeline\FireAndForget;
use MilliCache\Predis\Pipeline\Pipeline;
use MilliCache\Predis\Pipeline\RelayAtomic;
use MilliCache\Predis\Pipeline\RelayPipeline;
use MilliCache\Predis\PubSub\Consumer as PubSubConsumer;
use MilliCache\Predis\PubSub\RelayConsumer as RelayPubSubConsumer;
use MilliCache\Predis\Response\ErrorInterface as ErrorResponseInterface;
use MilliCache\Predis\Response\ResponseInterface;
use MilliCache\Predis\Response\ServerException;
use MilliCache\Predis\Transaction\MultiExec as MultiExecTransaction;
 ...
 *
 * This is the main high-level abstraction of MilliCache\Predis upon which various other
...
class Client implements ClientInterface, IteratorAggregate
{
     ...
     *  - Instance of MilliCache\Predis\Connection\ParametersInterface (used as-is)
     *  - Instance of MilliCache\Predis\Connection\ConnectionInterface (returned as-is)
     *
     * When a callable is passed, it receives the original set of client options
     * and must return an instance of MilliCache\Predis\Connection\ConnectionInterface.
     *
