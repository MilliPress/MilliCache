...
use MilliCache\Deps\Predis\Cluster\Distributor\DistributorInterface;
use MilliCache\Deps\Predis\Cluster\Distributor\HashRing;

/**
 * Default cluster strategy used by MilliCache\Deps\Predis to handle client-side sharding.
 */
