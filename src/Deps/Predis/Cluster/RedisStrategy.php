...
namespace MilliCache\Deps\Predis\Cluster;

use MilliCache\Deps\Predis\Cluster\Hash\CRC16;
use MilliCache\Deps\Predis\Cluster\Hash\HashGeneratorInterface;
use MilliCache\Deps\Predis\NotSupportedException;

/**
 * Default class used by MilliCache\Deps\Predis to calculate hashes out of keys of
