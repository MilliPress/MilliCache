...
/**
 * This class provides the implementation of a MilliCache\Deps\Predis connection that
...
class RelayConnection extends StreamConnection
{
    ...
    public function executeCommand(CommandInterface $command)
    {
        ...
        try {
            ...
            // handler for `MilliCache\Deps\Predis\Command\RawCommand` calls, currently both
