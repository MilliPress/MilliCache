...
use MilliCache\Deps\Predis\ClientException;
use MilliCache\Deps\Predis\Cluster\RedisStrategy as RedisClusterStrategy;
use MilliCache\Deps\Predis\Cluster\SlotMap;
use MilliCache\Deps\Predis\Cluster\StrategyInterface;
...
use MilliCache\Deps\Predis\Connection\FactoryInterface;
use MilliCache\Deps\Predis\Connection\NodeConnectionInterface;
use MilliCache\Deps\Predis\NotSupportedException;
use MilliCache\Deps\Predis\Response\Error as ErrorResponse;
 ...
 * the cluster, MilliCache\Deps\Predis will do the rest by adjusting the slots map and creating
