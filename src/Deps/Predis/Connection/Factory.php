...
namespace MilliCache\Deps\Predis\Connection;
...
class Factory implements FactoryInterface
{
    ...
    protected $schemes = [
        'tcp' => 'MilliCache\Deps\Predis\Connection\StreamConnection',
        'unix' => 'MilliCache\Deps\Predis\Connection\StreamConnection',
        'tls' => 'MilliCache\Deps\Predis\Connection\StreamConnection',
        'redis' => 'MilliCache\Deps\Predis\Connection\StreamConnection',
        'rediss' => 'MilliCache\Deps\Predis\Connection\StreamConnection',
        'http' => 'MilliCache\Deps\Predis\Connection\WebdisConnection',
    ];

    /**
     * Checks if the provided argument represents a valid connection class
     * implementing MilliCache\Deps\Predis\Connection\NodeConnectionInterface. Optionally,
    ...
    protected function checkInitializer($initializer)
    {
        ...
        if (!$class->isSubclassOf('MilliCache\Deps\Predis\Connection\NodeConnectionInterface')) {
    ...
    public function create($parameters)
    {
        ...
        if (!$connection instanceof NodeConnectionInterface) {
            throw new UnexpectedValueException(
                ...
                "'MilliCache\Deps\Predis\Connection\NodeConnectionInterface'."
            );
        }
