...
use MilliCache\Deps\Predis\Command\RawCommand;
use MilliCache\Deps\Predis\Command\Redis\Container\ContainerFactory;
use MilliCache\Deps\Predis\Command\Redis\Container\ContainerInterface;
use MilliCache\Deps\Predis\Command\ScriptCommand;
use MilliCache\Deps\Predis\Configuration\Options;
use MilliCache\Deps\Predis\Configuration\OptionsInterface;
use MilliCache\Deps\Predis\Connection\ConnectionInterface;
use MilliCache\Deps\Predis\Connection\Parameters;
use MilliCache\Deps\Predis\Connection\ParametersInterface;
use MilliCache\Deps\Predis\Connection\RelayConnection;
use MilliCache\Deps\Predis\Monitor\Consumer as MonitorConsumer;
use MilliCache\Deps\Predis\Pipeline\Atomic;
use MilliCache\Deps\Predis\Pipeline\FireAndForget;
use MilliCache\Deps\Predis\Pipeline\Pipeline;
use MilliCache\Deps\Predis\Pipeline\RelayAtomic;
use MilliCache\Deps\Predis\Pipeline\RelayPipeline;
use MilliCache\Deps\Predis\PubSub\Consumer as PubSubConsumer;
use MilliCache\Deps\Predis\PubSub\RelayConsumer as RelayPubSubConsumer;
use MilliCache\Deps\Predis\Response\ErrorInterface as ErrorResponseInterface;
use MilliCache\Deps\Predis\Response\ResponseInterface;
use MilliCache\Deps\Predis\Response\ServerException;
use MilliCache\Deps\Predis\Transaction\MultiExec as MultiExecTransaction;
 ...
 *
 * This is the main high-level abstraction of MilliCache\Deps\Predis upon which various other
...
class Client implements ClientInterface, IteratorAggregate
{
     ...
     *  - Instance of MilliCache\Deps\Predis\Connection\ParametersInterface (used as-is)
     *  - Instance of MilliCache\Deps\Predis\Connection\ConnectionInterface (returned as-is)
     *
     * When a callable is passed, it receives the original set of client options
     * and must return an instance of MilliCache\Deps\Predis\Connection\ConnectionInterface.
     *
