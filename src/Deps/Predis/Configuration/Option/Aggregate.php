...
namespace MilliCache\Deps\Predis\Configuration\Option;

use InvalidArgumentException;
use MilliCache\Deps\Predis\Configuration\OptionInterface;
 ...
 * connection instance of MilliCache\Deps\Predis\Connection\AggregateConnectionInterface when
...
class Aggregate implements OptionInterface
{
     ...
     * following arguments:
     *
     * - $parameters (same as passed to MilliCache\Deps\Predis\Client::__construct())
     * - $options (options container, MilliCache\Deps\Predis\Configuration\OptionsInterface)
     * - $option (current option, MilliCache\Deps\Predis\Configuration\OptionInterface)
     *
     * The original callable must return a valid aggregation connection instance
     * of type MilliCache\Deps\Predis\Connection\AggregateConnectionInterface, this is enforced
