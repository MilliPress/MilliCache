...
use MilliCache\Deps\Predis\Command\RawFactory;
use MilliCache\Deps\Predis\Command\RedisFactory;
...
class Commands implements OptionInterface
{
     ...
     *
     * - "predis" returns the default command factory used by MilliCache\Deps\Predis
