...
namespace MilliCache\Deps\Predis\Command\Processor;

use InvalidArgumentException;
use MilliCache\Deps\Predis\Command\CommandInterface;
use MilliCache\Deps\Predis\Command\PrefixableCommandInterface;
...
class KeyPrefixProcessor implements ProcessorInterface
{
     ...
     *
     *   - MilliCache\Deps\Predis\Command\CommandInterface (command instance)
     *   - String (prefix)
     *
