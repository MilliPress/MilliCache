...
use MilliCache\Deps\Predis\Command\Processor\ProcessorInterface;
...
abstract class Factory implements FactoryInterface
{
     ...
     *
     * Only classes implementing MilliCache\Deps\Predis\Command\CommandInterface are allowed to
     ...
     *
     * @param string $commandID    Command ID
     * @param string $commandClass FQCN of a class implementing MilliCache\Deps\Predis\Command\CommandInterface
     *
     * @throws InvalidArgumentException
     */
    public function define(string $commandID, string $commandClass): void
    {
        if (!is_a($commandClass, 'MilliCache\Deps\Predis\Command\CommandInterface', true)) {
            throw new InvalidArgumentException(
                "Class $commandClass must implement MilliCache\Deps\Predis\Command\CommandInterface"
            );
        }
