...
namespace MilliCache\Deps\Predis\Command;

use MilliCache\Deps\Predis\ClientConfiguration;
use MilliCache\Deps\Predis\Command\Redis\FUNCTIONS;
 ...
 * class in the MilliCache\Deps\Predis\Command\Redis namespace but this can be overridden for
 * any command ID simply by defining a new command handler class implementing
 * MilliCache\Deps\Predis\Command\CommandInterface.
 */
class RedisFactory extends Factory
{
    private const COMMANDS_NAMESPACE = "MilliCache\Deps\Predis\Command\Redis";

    public function __construct()
    {
        $this->commands = [
            'ECHO' => 'MilliCache\Deps\Predis\Command\Redis\ECHO_',
            'EVAL' => 'MilliCache\Deps\Predis\Command\Redis\EVAL_',
            'OBJECT' => 'MilliCache\Deps\Predis\Command\Redis\OBJECT_',
    ...
    public function undefine(string $commandID): void
    {
        ...
        // a predefined class from the MilliCache\Deps\Predis\Command\Redis namespace when no
