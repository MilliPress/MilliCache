...
namespace MilliCache\Deps\Predis\Transaction;

use Exception;
use InvalidArgumentException;
use MilliCache\Deps\Predis\ClientContextInterface;
use MilliCache\Deps\Predis\ClientException;
use MilliCache\Deps\Predis\ClientInterface;
use MilliCache\Deps\Predis\Command\CommandInterface;
use MilliCache\Deps\Predis\CommunicationException;
use MilliCache\Deps\Predis\Connection\Cluster\ClusterInterface;
...
use MilliCache\Deps\Predis\Response\Status as StatusResponse;
...
class MultiExec implements ClientContextInterface
{
    ...
    private function onProtocolError($message)
    {
        ...
        // connections we can safely assume that MilliCache\Deps\Predis\Client::getConnection()
        // will return a MilliCache\Deps\Predis\Connection\NodeConnectionInterface instance.
