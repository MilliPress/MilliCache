...
namespace MilliCache\Deps\Predis\Connection\Replication;
...
use MilliCache\Deps\Predis\Connection\FactoryInterface as ConnectionFactoryInterface;
use MilliCache\Deps\Predis\Connection\NodeConnectionInterface;
use MilliCache\Deps\Predis\Connection\Parameters;
use MilliCache\Deps\Predis\Replication\ReplicationStrategy;
use MilliCache\Deps\Predis\Replication\RoleException;
    ...
    public function getSentinelConnection()
    {
        if (!$this->sentinelConnection) {
            if ($this->sentinelIndex >= count($this->sentinels)) {
                ...
                throw new \MilliCache\Deps\Predis\ClientException('No sentinel server available for autodiscovery.');
            }
