 ...
 */
namespace MilliCache\Deps\Predis\Protocol\Text;
...
use MilliCache\Deps\Predis\Protocol\ResponseReaderInterface;
/**
...
class ResponseReader implements ResponseReaderInterface
{
    ...
    {
        return ['+' => new Handler\StatusResponse(), '-' => new Handler\ErrorResponse(), ':' => new Handler\IntegerResponse(), '$' => new Handler\BulkResponse(), '*' => new Handler\MultiBulkResponse()];
    }
    /**
     ...
     */
    public function setHandler($prefix, \MilliCache\Deps\Predis\Protocol\Text\Handler\ResponseHandlerInterface $handler)
    {
