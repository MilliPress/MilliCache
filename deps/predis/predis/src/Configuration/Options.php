 ...
 */
namespace MilliCache\Deps\Predis\Configuration;
...
{
    /** @var array */
    protected $handlers = ['aggregate' => \MilliCache\Deps\Predis\Configuration\Option\Aggregate::class, 'cluster' => \MilliCache\Deps\Predis\Configuration\Option\Cluster::class, 'replication' => \MilliCache\Deps\Predis\Configuration\Option\Replication::class, 'connections' => \MilliCache\Deps\Predis\Configuration\Option\Connections::class, 'commands' => \MilliCache\Deps\Predis\Configuration\Option\Commands::class, 'exceptions' => \MilliCache\Deps\Predis\Configuration\Option\Exceptions::class, 'prefix' => \MilliCache\Deps\Predis\Configuration\Option\Prefix::class, 'crc16' => \MilliCache\Deps\Predis\Configuration\Option\CRC16::class];
    /** @var array */
    protected $options = [];
    /** @var array */
    protected $input;
