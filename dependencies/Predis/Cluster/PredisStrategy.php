...
use MilliCache\Predis\Cluster\Distributor\DistributorInterface;
use MilliCache\Predis\Cluster\Distributor\HashRing;

/**
 * Default cluster strategy used by MilliCache\Predis to handle client-side sharding.
 */
