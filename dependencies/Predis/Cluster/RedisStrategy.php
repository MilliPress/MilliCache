...
namespace MilliCache\Predis\Cluster;

use MilliCache\Predis\Cluster\Hash\CRC16;
use MilliCache\Predis\Cluster\Hash\HashGeneratorInterface;
use MilliCache\Predis\NotSupportedException;

/**
 * Default class used by MilliCache\Predis to calculate hashes out of keys of
