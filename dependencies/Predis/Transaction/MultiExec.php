...
namespace MilliCache\Predis\Transaction;

use Exception;
use InvalidArgumentException;
use MilliCache\Predis\ClientContextInterface;
...
use MilliCache\Predis\Connection\Cluster\ClusterInterface;
...
class MultiExec implements ClientContextInterface
{
    ...
    private function onProtocolError($message)
    {
        ...
        // connections we can safely assume that MilliCache\Predis\Client::getConnection()
        // will return a MilliCache\Predis\Connection\NodeConnectionInterface instance.
