...
namespace MilliCache\Predis\Configuration\Option;

use InvalidArgumentException;
use MilliCache\Predis\Configuration\OptionInterface;
use MilliCache\Predis\Configuration\OptionsInterface;
use MilliCache\Predis\Connection\AggregateConnectionInterface;
 ...
 * connection instance of MilliCache\Predis\Connection\AggregateConnectionInterface when
...
class Aggregate implements OptionInterface
{
     ...
     * following arguments:
     *
     * - $parameters (same as passed to MilliCache\Predis\Client::__construct())
     * - $options (options container, MilliCache\Predis\Configuration\OptionsInterface)
     * - $option (current option, MilliCache\Predis\Configuration\OptionInterface)
     *
     * The original callable must return a valid aggregation connection instance
     * of type MilliCache\Predis\Connection\AggregateConnectionInterface, this is enforced
