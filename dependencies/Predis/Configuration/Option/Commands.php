...
use MilliCache\Predis\Command\RawFactory;
use MilliCache\Predis\Command\RedisFactory;
...
class Commands implements OptionInterface
{
     ...
     *
     * - "predis" returns the default command factory used by MilliCache\Predis
