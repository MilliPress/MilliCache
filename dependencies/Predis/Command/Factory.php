...
use MilliCache\Predis\Command\Processor\ProcessorInterface;
...
abstract class Factory implements FactoryInterface
{
     ...
     *
     * Only classes implementing MilliCache\Predis\Command\CommandInterface are allowed to
     ...
     *
     * @param string $commandID    Command ID
     * @param string $commandClass FQCN of a class implementing MilliCache\Predis\Command\CommandInterface
     *
     * @throws InvalidArgumentException
     */
    public function define(string $commandID, string $commandClass): void
    {
        if (!is_a($commandClass, 'MilliCache\Predis\Command\CommandInterface', true)) {
            throw new InvalidArgumentException(
                "Class $commandClass must implement MilliCache\Predis\Command\CommandInterface"
            );
        }
