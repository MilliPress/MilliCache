...
namespace MilliCache\Predis\Connection\Replication;
...
use MilliCache\Predis\Connection\FactoryInterface as ConnectionFactoryInterface;
use MilliCache\Predis\Connection\NodeConnectionInterface;
use MilliCache\Predis\Connection\Parameters;
use MilliCache\Predis\Replication\ReplicationStrategy;
use MilliCache\Predis\Replication\RoleException;
    ...
    public function getSentinelConnection()
    {
        if (!$this->sentinelConnection) {
            if ($this->sentinelIndex >= count($this->sentinels)) {
                ...
                throw new \MilliCache\Predis\ClientException('No sentinel server available for autodiscovery.');
            }
