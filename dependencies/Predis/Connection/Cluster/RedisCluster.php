...
namespace MilliCache\Predis\Connection\Cluster;

use ArrayIterator;
use Countable;
use IteratorAggregate;
use OutOfBoundsException;
use MilliCache\Predis\ClientException;
use MilliCache\Predis\Cluster\RedisStrategy as RedisClusterStrategy;
use MilliCache\Predis\Cluster\SlotMap;
use MilliCache\Predis\Cluster\StrategyInterface;
...
use MilliCache\Predis\Connection\FactoryInterface;
use MilliCache\Predis\Connection\NodeConnectionInterface;
use MilliCache\Predis\NotSupportedException;
use MilliCache\Predis\Response\Error as ErrorResponse;
 ...
 * the cluster, MilliCache\Predis will do the rest by adjusting the slots map and creating
