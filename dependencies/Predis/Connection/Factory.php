...
namespace MilliCache\Predis\Connection;
...
class Factory implements FactoryInterface
{
    ...
    protected $schemes = [
        'tcp' => 'MilliCache\Predis\Connection\StreamConnection',
        'unix' => 'MilliCache\Predis\Connection\StreamConnection',
        'tls' => 'MilliCache\Predis\Connection\StreamConnection',
        'redis' => 'MilliCache\Predis\Connection\StreamConnection',
        'rediss' => 'MilliCache\Predis\Connection\StreamConnection',
        'http' => 'MilliCache\Predis\Connection\WebdisConnection',
    ];

    /**
     * Checks if the provided argument represents a valid connection class
     * implementing MilliCache\Predis\Connection\NodeConnectionInterface. Optionally,
    ...
    protected function checkInitializer($initializer)
    {
        ...
        if (!$class->isSubclassOf('MilliCache\Predis\Connection\NodeConnectionInterface')) {
    ...
    public function create($parameters)
    {
        ...
        if (!$connection instanceof NodeConnectionInterface) {
            throw new UnexpectedValueException(
                ...
                "'MilliCache\Predis\Connection\NodeConnectionInterface'."
            );
        }
